...
log = logging.getLogger('Simulate Horizontal Investment Coordination for Transmission Expansion Planning in Centralized mode')
log.setLevel(logging.DEBUG)

logfile = os.path.join(os.getcwd(), "Simulate Horizontal Investment Coordination for Transmission Expansion Planning in Centralized mode.log")
