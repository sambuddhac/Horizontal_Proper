...
public class Network extends Thread {
	private int nodeNumber; // Number of Nodes
	private Vector<Integer> nodeNumVector = new Vector<>(); // Vector of subnet number of nodes
	private Vector<Integer> SELineSerList = new Vector<>(); // List of the global ID of SE lines
	private Vector<Integer> candLineSerList = new Vector<>(); // List of the global ID of shared candidate lines
	private int univNodeNum = 0; // Initialize the total number of nodes of all the zones
	private int univGenNum = 0; // Initialize the universal generator number
	private int univTranNum = 0; // Initialize the universal transmission line number
	private int univLoadNum = 0; // Initialize the universal load number
	private int univIntCandNum = 0; // Initialize the universal intra zonal candidate line number
	private int univSELineNum = 0; // Initialize the universal shared existing line number
	private int univCandLineNum = 0; // Initialize the universal shared candidate line number
	private int genNumber = 0; // Number of Generators
	private int tranNumber = 0; // Number of Transmission lines
	private int loadNumber = 0; // Number of Loads
	private int zonalCount = 0; // Total number of different zones
	private int countOfScenarios = 0; // Number of total random scenarios
	private int sharedELines = 0; // Number of shared existing transmission lines
	private int sharedCLines = 0; // Number of shared candidate transmission lines
	private int internalCLines = 0; // NUmber of internal candidate transmission lines
	private int simMode = 0; // Mode of the simulation: Average Heat Rate, Piece-wise Linear, Polynomial (Cubic) Convex cost curve
	private char genFile[]; // String for storing the name of the generator file
	private char tranFile[]; // String for storing the name of the transmission line file
	private char loadFile[]; // String for storing the name of the load file
	private char netFile[]; // String for storing the name of the network file
	private char sharedLineFile[]; // String for storing the name of the shared existing lines file
	private char candLineFile[]; // String for storing the name of the candidate lines file
	private char intCandLineFile[]; // String for storing the name of the internal/intra-zonal candidate lines file
	private Vector<Powergenerator> genObject = new Vector<Powergenerator>(); // Set of Powergenerator objects
	private Vector<Load> loadObject = new Vector<Load>(); // set of load objects
	private Vector<transmissionLine> translObject = new Vector<transmissionLine>() // set of transmission line objects
	private Vector<Node> nodeObject = new Vector<Node>(); // set of node objects
	private Vector<SELine> SELineObject = new Vector<SELine>(); // set of existing shared lines objects
	private Vector<candLine> candLineObject = new Vector<candLine>(); // set of shared candidate lines objects
	private Vector<intCandLine> intCandLineObject = new Vector<intCandLine>(); // set of internal candidate line objects
	private Vector<Double> probability; // Probability of the different scenarios

	public Nettran(String initSummary[], int zoneCount, int objChoice) { // constructor
		this.simMode = objChoice; // Specify the type of the curve
		this.zonalCount = zoneCount;
		this.nodeNumVector.add(0); // Initialize the node number vector to indicate there no nodes in the fictitous 0-th zone
