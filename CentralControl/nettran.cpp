...
Nettran::Nettran(string initSummary[], int zoneCount, int objChoice) // constructor
	: simMode(objChoice), // Specify the type of the curve
	  zonalCount(zoneCount)
{
	...
	nodeNumVector.push_back(0); // Initialize the node number vector to indicate there no nodes in the fictitous 0-th zone
